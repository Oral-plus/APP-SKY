...
class _TransactionCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isOutgoing = transaction.usuarioOrigenId != null;
    final statusColor = _getStatusColor(transaction.estado);
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        transaction.nombreDestino ?? transaction.tipoNombre,
                ...
                Column(
                  ...
                  children: [
                    Text(
                      '${isOutgoing ? '-' : '+'}${transaction.montoFormateado}',
                      style: TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: isOutgoing ? AppTheme.errorColor : AppTheme.accentColor,
                      ),
                    ),
                    const SizedBox(height: 4),
                    Container(
