...
// Colores elegantes estilo Apple, mejorados para más profesionalismo
...
String formatPrice(dynamic price) {
  ...
  final number = double.tryParse(price.toString().replaceAll(RegExp(r'[^\d.]'), '')) ?? 0;
...
class _ProductsTabState extends State<ProductsTab> with TickerProviderStateMixin {
  ...
  Future<void> _loadUserAndSapData() async {
    ...
    try {
      ...
      setState(() {
        _currentUser = user;
        _codigoClienteActual = user.documento; // Usar documento como código de cliente
  ...
  Future<void> _cargarPreciosSAP(List<String> codigos) async {
    ...
    try {
      final resultado = await InvoiceService1.obtenerPreciosSAP(
        codigos, 
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          const Text('Precios Actualizados', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                          Text(
                            'Lista de precios: ${resultado['lista_precios_usada']} - ${_preciosSAP.length} productos',
                            style: TextStyle(fontWeight: FontWeight.w400, fontSize: 12, color: Colors.white.withOpacity(0.9)),
                            maxLines: 1,
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Text('Precios por Defecto', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                          Text(
  ...
  void _actualizarPreciosEnTiempoReal() {
        ...
        if (_allProducts[i]['codigoSapSuave'] != null) {
          ...
          if (_preciosSAP.containsKey(codigoSapSuave)) {
            ...
            if (precioSAPSuave != 'Precio no disponible') {
              _allProducts[i]['priceSuave'] = '\$${formatPrice(precioSAPSuave)}';
            }
          }
        }
        ...
        if (_allProducts[i]['codigoSapAlternativo'] != null) {
          ...
          if (_preciosSAP.containsKey(codigoSapAlt)) {
            ...
            if (precioSAPAlt != 'Precio no disponible') {
              _allProducts[i]['priceAlternativo'] = '\$${formatPrice(precioSAPAlt)}';
            }
          }
        }
      }
    ...
    print('✅ Precios actualizados en tiempo real para ${_allProducts.length} productos');
  }
  ...
  Future<void> _cargarEstadosSAP(List<String> codigos) async {
    ...
    try {
      final resultado = await InvoiceService1.obtenerEstadosProductosSAP(
        codigos, 
  ...
  void _actualizarEstadosEnTiempoReal() {
    ...
    print('✅ Estados actualizados en tiempo real para ${_allProducts.length} productos');
  }
  ...
  String _obtenerPrecioSAP(String codigoSap) {
    if (_preciosSAP.containsKey(codigoSap)) {
      ...
      return InvoiceService1.formatearPrecioSAP(precio);
    }
  ...
  String _obtenerMensajeEstado(String codigoSap) {
    if (_estadosSAP.containsKey(codigoSap)) {
      ...
      return InvoiceService1.obtenerMensajeEstado(_estadosSAP[codigoSap]!);
    }
  ...
  void _addToCart(Map<String, dynamic> product) {
    ...
    final disponible = codigoSap.isNotEmpty ? _productoDisponible(codigoSap) : true;
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        const Text('Producto No Disponible', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                        Text(
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Text('Agregado al Carrito', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
                      Text(
          ...
          return Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [backgroundColor, backgroundColor.withOpacity(0.8), Colors.white],
              ),
            ),
            child: FadeTransition(
              ...
              child: Column(
                children: [
                  SizedBox(height: kToolbarHeight + context.responsiveHeight(40)),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.search_rounded, color: primaryBlue, size: context.responsive(20)),
  ...
  Widget _buildScrollableProductsGrid(List<Map<String, dynamic>> products, Color themeColor) {
  ...
  PreferredSizeWidget _buildAppBar() {
    return PreferredSize(
      preferredSize: Size.fromHeight(kToolbarHeight + context.responsiveHeight(10)),
    ...
    return [
      {
        ...
        'rating': '5.0',
        'description': 'Mango ergonómico que se adapta perfectamente a tu mano con inclinación en forma de espejo odontológico para llegar fácil a todas las dentaduras.',
        ...
        'features': ['Cerdas ultra suaves', 'Mango ergonómico', 'Tecnología avanzada', 'Cuidado de encías'],
        'specifications': {
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Cerdas medias', 'Limpieza efectiva', 'Diseño ergonómico', 'Uso diario'],
        'specifications': {
          'Dureza': 'Media',
          'Tamaño': 'Estándar',
        }
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Tamaño compacto', 'Estuche incluido', 'Portátil', 'Cerdas suaves'],
        'specifications': {
          'Dureza': 'Suave',
        }
      },
      {
        ...
        'rating': '5.0',
        'description': 'Cepillo ecológico con mango de bambú y cerdas naturales',
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Mango de bambú', 'Cerdas naturales', 'Biodegradable', 'Eco-friendly'],
        'specifications': {
      ...
      },
      {
        ...
        'rating': '5.0',
        'description': 'Diseño especial para limpieza con brackets y aparatos ortodónticos',
        'codigoSap': '50360167', // Media por defecto
        'textura': 'Media',
        'category': 'Cepillos',
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Diseño ortodóntico', 'Limpieza brackets', 'Cerdas especiales', 'Acceso fácil'],
        'specifications': {
  ...
  List<Map<String, dynamic>> _getCremasProducts() {
    return [
      ...
      },
      {
        ...
        'rating': '4.7',
        'description': 'Fórmula natural con extractos herbales para cuidado integral',
        'codigoSap': '50360371', // Estándar por defecto
        'category': 'Cremas',
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Extractos naturales', 'Sin químicos', 'Cuidado integral', 'Sabor herbal'],
        'specifications': {
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Protección anticaries', 'Fortalece esmalte', 'Sabor fresco'],
        'specifications': {
          'Contenido': '30g',
        }
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Cuidado 5 en 1', 'Blanquea y protege', 'Fortalece encías', 'Aliento fresco'],
        'specifications': {
          'Contenido': '70g',
        }
      },
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Cuidado 4 en 1', 'Blanquea y protege', 'Fortalece encías', 'Aliento fresco'],
        'specifications': {
          'Contenido': '151.2g',
        }
      },
    ...
    return [
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Protección 12 horas', 'Antibacterial', 'Aliento fresco', 'Sin alcohol'],
        'specifications': {
          'Contenido': 'Caja x24',
        }
      },
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Para sensibilidad', 'Alivio prolongado', 'Fórmula suave', 'Sin ardor'],
        'specifications': {
          'Contenido': '300ml',
        }
      },
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Ingredientes naturales', 'Extractos herbales', 'Sin químicos', 'Sabor natural'],
        'specifications': {
          'Contenido': '1000ml',
        }
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Especial niños', 'Sabor agradable', 'Sin alcohol', 'Fórmula suave'],
        'specifications': {
  ...
  List<Map<String, dynamic>> _getSedasProducts() {
    return [
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Ultra fina', 'Espacios pequeños', 'Suave deslizamiento', 'Sin sabor'],
        'specifications': {
          'Contenido': '30m',
          'Sabor': 'Menta',
        }
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Con flúor', 'Protección extra', 'Fortalece esmalte', 'Sabor menta'],
        'specifications': {
          'Contenido': '100m',
          'Sabor': 'Sin sabor',
        }
      ...
      },
      {
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Portátil', 'Dispensador compacto', 'Fácil uso', 'Higiénico'],
        'specifications': {
          'Longitud': '30m',
  ...
  List<Map<String, dynamic>> _getUniversoNinosProducts() {
    return [
      ...
      {
        'title': 'Kit Baby Panda',
        'price': formatPrice('6401'),
        'image': 'assets/NIÑOS/BABYPANDA.png',
        'rating': '5.0',
        'description': 'Kit Baby Panda',
      ...
      {
        'title': 'Kit Space Duo Niño + Cremas 30gr',
  ...
  List<Map<String, dynamic>> _getKitsProducts() {
    return [
      ...
      },
      {
        ...
        'rating': '5.0',
        'description': 'Solución completa para dientes sensibles con alivio inmediato',
        ...
        'disponible': true,
        'mensajeEstado': 'Producto disponible',
        'features': ['Para sensibilidad', 'Alivio inmediato', 'Protección 24h', 'Fórmulas suaves'],
        'specifications': {
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (products.isNotEmpty) _buildFeaturedProduct(products.first, themeColor),
  ...
  Widget _buildProductImage(Map<String, dynamic> product, Color themeColor, bool isFeatured) {
    ...
    return Hero(
      ...
      child: Container(
        height: isFeatured ? context.responsiveHeight(220) : context.responsiveHeight(150),
        width: double.infinity,
        decoration: BoxDecoration(
          borderRadius: BorderRadius.vertical(top: Radius.circular(context.responsiveRadius)),
          gradient: LinearGradient(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(Icons.star_rounded, color: Colors.amber, size: context.responsive(14)),
                    ...
                    Row(
                      children: [
                        ...
                        if (_cargandoPrecios && codigoSap.isNotEmpty)
                          Padding(
                            padding: EdgeInsets.only(left: context.responsive(8)),
                            child: SizedBox(
              ...
              Row(
                children: [
                  ...
                  _buildActionButton(
                    ...
                    Colors.white,
                    disponible ? () => _showTextureSelectionDialog(product) : null,
                  ),
                ],
              ),
            ],
  ...
  Widget _buildActionButton(String text, IconData icon, Color backgroundColor, Color textColor, VoidCallback? onTap) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildEnhancedTextureOption(
                          ...
                          _getTextureDescription(product['category'] == 'Cepillos' ? 'Media' : product['textura']!, product['category']),
                          product['codigoSap']!,
                          primaryBlue,
                          () {
                        ...
                        _buildEnhancedTextureOption(
                          ...
                          _getTextureDescription(product['category'] == 'Cepillos' ? 'Suave' : product['texturaAlternativa']!, product['category']),
  ...
  Widget _buildEnhancedTextureOption(String texture, String description, String codigoSap, Color accentColor, VoidCallback onTap) {
    final precioSAP = _obtenerPrecioSAP(codigoSap);
    final disponible = _productoDisponible(codigoSap);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(context.responsive(16)),
        border: Border.all(
          color: disponible ? accentColor.withOpacity(0.3) : Colors.grey.withOpacity(0.3), 
          width: 1.5
        ),
        boxShadow: [
          BoxShadow(
              ...
              child: Row(
                children: [
                  ...
                  Icon(
                    ...
                    color: disponible ? accentColor.withOpacity(0.7) : Colors.grey.withOpacity(0.7),
                    size: context.responsive(16),
                  ),
                ],
              ),
  ...
  Widget _buildProductsGrid(List<Map<String, dynamic>> products, Color themeColor) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: context.responsive(16)),
      child: LayoutBuilder(
        builder: (context, constraints) {
  ...
  Widget _buildProductCard(Map<String, dynamic> product, Color themeColor) {
    // ✅ INTEGRACIÓN SAP: Obtener datos actualizados y estado de disponibilidad
    final codigoSap = product['codigoSap'] ?? '';
    final precioSAP = codigoSap.isNotEmpty ? _obtenerPrecioSAP(codigoSap) : null;
    final precioMostrar = (precioSAP != null && precioSAP != 'Precio no disponible') 
        ? '\$${formatPrice(precioSAP)}'
  ...
  Widget _buildBackButton() {
    return IconButton(
      icon: Icon(Icons.arrow_back_ios_new_rounded, color: primaryBlue.withOpacity(0.8)),
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [primaryBlue.withOpacity(0.1), primaryBlue.withOpacity(0.05), Colors.white.withOpacity(0.8)],
            ),
...
// ✅ DIÁLOGO DE PREVISUALIZACIÓN SIMPLIFICADO
...
class _ProductPreviewDialogState extends State<ProductPreviewDialog>
  ...
  String _selectedTextura = '';
  String _selectedCodigoSap = '';
  ...
  void initState() {
    ...
    _selectedTextura = widget.product['textura'] ?? 'Media';
    _selectedCodigoSap = widget.product['codigoSap'] ?? '';
    _selectedPrice = widget.product['price'] ?? '\$0';
  }
  ...
  String _obtenerMensajeEstado(String codigoSap) {
    if (widget.estadosSAP.containsKey(codigoSap)) {
      ...
      return InvoiceService1.obtenerMensajeEstado(widget.estadosSAP[codigoSap]!);
    }
    return 'Producto disponible';
  }

  void _updateSelection(String textura, String codigoSap) {
    setState(() {
      _selectedTextura = textura;
      _selectedCodigoSap = codigoSap;
      final precioSAP = _obtenerPrecioSAP(codigoSap);
      _selectedPrice = (precioSAP != 'Precio no disponible') 
          ? '\$${formatPrice(precioSAP)}'
  ...
  @override
  Widget build(BuildContext context) {
    final hasOptions = widget.product['hasTextureOptions'] == true;
    final disponible = _productoDisponible(_selectedCodigoSap);
    final precioMostrar = _selectedPrice;
    final mensajeEstado = _obtenerMensajeEstado(_selectedCodigoSap);
            ...
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Column(
                  ...
                  children: [
                    _buildHeader(),
                    Flexible(child: _buildContent(precioMostrar, disponible, hasOptions, mensajeEstado)),
  ...
  Widget _buildContent(String precioMostrar, bool disponible, bool hasOptions, String mensajeEstado) {
    return SingleChildScrollView(
      padding: EdgeInsets.all(context.responsive(20)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildProductImage(),
          SizedBox(height: context.responsive(24)),
          if (hasOptions) _buildTextureSelection(),
          SizedBox(height: context.responsive(20)),
          _buildProductDetails(precioMostrar, disponible, mensajeEstado),
          SizedBox(height: context.responsive(20)),
          _buildFeatures(),
          SizedBox(height: context.responsive(20)),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: _buildTextureButton(
                widget.product['textura'] ?? 'Media',
                widget.product['codigoSap'],
                primaryBlue,
              ),
            ),
            SizedBox(width: context.responsive(12)),
            Expanded(
              child: _buildTextureButton(
                widget.product['texturaAlternativa'] ?? 'Suave',
                widget.product['codigoSapAlternativo'] ?? widget.product['codigoSapSuave'],
                secondaryBlue,
              ),
            ),
          ],
  ...
  Widget _buildTextureButton(String textura, String? codigoSap, Color color) {
    if (codigoSap == null) return const SizedBox.shrink();
    final isSelected = _selectedTextura == textura;
    final disponible = _productoDisponible(codigoSap);
    ...
    return Container(
      ...
      child: Material(
        color: Colors.transparent,
        child: InkWell(
          onTap: disponible ? () => _updateSelection(textura, codigoSap) : null,
          child: Center(
            child: Text(
              textura,
              style: TextStyle(
                color: disponible ? (isSelected ? color : textPrimary) : textSecondary,
                fontWeight: FontWeight.w600,
              ),
            ),
          ),
  ...
  Widget _buildProductDetails(String precioMostrar, bool disponible, String mensajeEstado) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            ...
            Row(
              children: [
                Icon(Icons.star_rounded, color: Colors.amber, size: context.responsive(16)),
                SizedBox(width: context.responsive(4)),
                Text(
  ...
  Widget _buildSpecifications() {
    final specs = widget.product['specifications'] as Map<String, String>? ?? {};
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: specs.entries.map((entry) => Container(
              padding: EdgeInsets.all(context.responsive(16)),
              decoration: BoxDecoration(
                border: Border(
                  bottom: BorderSide(
            ...
            child: Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(context.responsive(25)),
                  onTap: disponible ? () {
                    final selectedProduct = Map<String, dynamic>.from(widget.product);
                    selectedProduct['textura'] = _selectedTextura;
                    selectedProduct['codigoSap'] = _selectedCodigoSap;
                    selectedProduct['price'] = _selectedPrice;
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  Text(
                    '\$${formatPrice(_cartManager.totalAmount)}',
                    style: TextStyle(
                      fontSize: context.clampFont(20, 28, 24),
                      fontWeight: FontWeight.w900,
                      color: primaryBlue,
